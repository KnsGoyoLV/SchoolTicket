    ...
    foreach ($rows as $row) {
      ...
      <td>
        ...
        <form method="post">
            ...
            <button type="button" class="btn btn-warning btn-rounded" data-toggle="modal" data-target="#squarespaceModal" name="edit<?=$row['ticket_id'];?>"value=<?=$row['ticket_id'];?>>Rediģēt</button>
